...
<div class="container">
  <div class="col-sm-9 col-xs-12 cfp-page">
    ...
    <p class="text-justify">Questions regarding Acta Cogitata can be sent to <a href="mailto:{{ 'ActaCogitata@gmail.com' | encode_email }}" rel="nofollow noopener noreferrer">ActaCogitata@gmail.com</a> or to <a href="mailto:{{ 'wkoolage@emich.edu' | encode_email }}" rel="nofollow noopener noreferrer">Dr. W. John Koolage</a>.</p>
  </div>
  {% include box.html %}
</div>
